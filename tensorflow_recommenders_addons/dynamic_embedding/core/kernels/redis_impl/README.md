...
```json
{
      ...
      "using_small_key": False,  // If True, each embedding id will have an independent key (using SET/GET). If False, use hash table (HMSET/HMGET) to store multiple ids in one key.
